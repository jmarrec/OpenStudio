...
BENCHMARK_CAPTURE(BM_ParseEnergyPlusIdd, New, std::string("New"))->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(BM_ParseEnergyPlusIdd, NewParallel, std::string("NewParallel"))->Unit(benchmark::kMillisecond);

BENCHMARK_CAPTURE(BM_ParseOpenStudioIdd, Old, std::string("Old"))->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(BM_ParseOpenStudioIdd, New, std::string("New"))->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(BM_ParseOpenStudioIdd, NewParallel, std::string("NewParallel"))->Unit(benchmark::kMillisecond);
